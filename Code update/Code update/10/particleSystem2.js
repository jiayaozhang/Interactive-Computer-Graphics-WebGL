...
function particle(){
    ...
    //set up random colors, positions and velocities
...
var update = function(){
    for (var i = 0; i < numParticles; i++ ) {
            ...
            particles[i].velocity = add( particles[i].velocity, scale(speed*dt/ particles[i].mass, forces(particles[i])));
        }
